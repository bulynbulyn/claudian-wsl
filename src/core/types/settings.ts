...
export interface ClaudianSettings {
  ...
  wslEnabled: boolean;              // Enable WSL2 mode
  wslDistro: string;                // Default WSL2 distribution name
  wslClaudePath: string;            // Claude CLI path inside WSL (e.g., /home/user/.local/bin/claude)
...
export const DEFAULT_SETTINGS: ClaudianSettings = {
  ...
  // WSL configuration (Windows only)
  wslEnabled: false,  // Disabled by default
  wslDistro: '',  // No default distro
  wslClaudePath: '',  // No default path
